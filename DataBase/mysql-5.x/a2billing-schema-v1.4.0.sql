...
-- | Translated and adapted to Brazilian Portuguese by  Jeferson Padilha |

INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(1, 'Número de Duração do Cartão', 'interval_len_cardnumber', '10-15', 'No Número de Duração do Cartão, você pode definir um intervalo, por ex: 10-15.', 0, '10-15,5-20,10-30', 'global');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(2, 'Alias para a Duração do Cartão', 'len_aliasnumber', '15', 'Alias para a Duração do Cartão, por ex: 15.', 0, NULL, 'global');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(3, 'Comprovante de Duração', 'len_voucher', '15', 'Número do Comprovante de Duração.', 0, NULL, 'global');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(4, 'Moeda Base', 'base_currency', 'brl', 'Moeda base para uso do aplicativo.', 0, NULL, 'global');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(5, 'Imagem da Fatura', 'invoice_image', 'asterisk01.jpg', 'Imagem a ser exibida no top da Nota Fiscal', 0, NULL, 'global');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(6, 'Email do Administrador', 'admin_email', 'root@localhost', 'Endereço de e-mail do Administrador do Site.', 0, NULL, 'global');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(7, 'Dia de Pagamento da Fatura DID', 'didbilling_daytopay', '5', 'DID (Direct-Inward-Dial) Discagem Direta Local', 0, NULL, 'global');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(8, 'Alterar Host', 'manager_host', 'localhost', 'Alterar o endereço do host', 0, NULL, 'global');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(9, 'Alterar User ID', 'manager_username', 'myasterisk', 'Alterar nome de usuário do Host', 0, NULL, 'global');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(10, 'Alterar Password', 'manager_secret', 'mycode', 'Alterar senha do Host', 0, NULL, 'global');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(11, 'Usar SMTP Server', 'smtp_server', '0', 'Defina se deseja usar um servidor SMTP ou SendMail (valor yes para o servidor SMTP)', 1, 'yes,no', 'global');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(12, 'SMTP Host', 'smtp_host', 'localhost', 'Hostname do servidor SMTP', 0, NULL, 'global');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(13, 'SMTP UserName', 'smtp_username', '', 'Nome de usuário para se conectar no servidor SMTP', 0, NULL, 'global');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(14, 'SMTP Password', 'smtp_password', '', 'Senha para se conectar no servidor SMTP', 0, NULL, 'global');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(15, 'Usar em Tempo Real', 'use_realtime', '1', 'Se desativado, ele irá gerar os arquivos de configuração e oferecer uma opção para recarregar o Asterisk depois de atualizar as configurações Voip', 1, 'yes,no', 'global');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(16, 'GoTo do Cliente', 'customer_ui_url', '../../customer/index.php', 'Link para a conta do cliente', 0, NULL, 'global');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(17, 'Contexto de Callback', 'context_callback', 'a2billing-callback', 'Contextualização para usar em Callback', 0, NULL, 'callback');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(18, 'Extensão', 'extension', '1000', 'Extensão para chamar durante um Callback.', 0, NULL, 'callback');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(19, 'Espera antes de Callback', 'sec_wait_before_callback', '10', 'Tempode espera, em segundos, antes de efetuar um Callback.', 0, NULL, 'callback');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(20, 'Evitar Repetição', 'sec_avoid_repeate', '10', 'Tempo, em segundos, de espera antes de repetir o Callback para evitar chamadas repetidas e indesejadas.', 0, NULL, 'callback');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(21, 'Tempo Limite', 'timeout', '20', 'se Callback não for bem sucedido nop tempo definido, então a chamada será considerada como falha.', 0, NULL, 'callback');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(22, 'Responder Chamadas', 'answer_call', '1', 'se desejar responder as chamadas manualmente. Desabilitar esta trigger para o Callback faz com as chamadas não fiquem penduradas no anel.', 1, 'yes,no', 'callback');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(23, 'No de Chamadas Previstas', 'nb_predictive_call', '10', 'defina o número de chamadas que um agente pode fazer quando o botão de chamada é clicado.', 0, NULL, 'callback');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(24, 'Atraso de Disponibilidade', 'nb_day_wait_before_retry', '1', 'Número de dias em espera antes do número ficar disponível para ligação novamente.', 0, NULL, 'callback');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(25, 'Red. Predefinido', 'context_preditctivedialer', 'a2billing-predictivedialer', 'Contexto para redirecionamento predefinido de chamadas.', 0, NULL, 'callback');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(26, 'Duração Max da Chamada', 'predictivedialer_maxtime_tocall', '5400', 'Quando uma chamada é feita, precisamos limitar a duração da chamada: quantidade em segundos.', 0, NULL, 'callback');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(27, 'PD Caller ID', 'callerid', '123456', 'Defina o callerID para o discador preditivo e callback.', 0, NULL, 'callback');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(28, 'Callback CallPlan ID', 'all_callback_tariff', '1', 'Plano de identificação de chamada para uso no modo all-callback, verificar a identificação na "Lista de Planos de Chamada" - WebUI.', 0, NULL, 'callback');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(29, 'Server Group ID', 'id_server_group', '1', 'Definir o grupo de servidores que vão ser utilizados pelo callback.', 0, NULL, 'callback');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(30, 'Audio Intro', 'callback_audio_intro', 'prepaid-callback_intro', 'Mensagem de introdução de áudio quando o callback é iniciado.', 0, NULL, 'callback');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(31, 'Signup URL', 'signup_page_url', '', 'URL da página de saida para aparecer na página de entrada(se o link não estiver vazio irá aparecer).', 0, NULL, 'webcustomerui');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(32, 'Metodo de Pagamento', 'paymentmethod', '1', 'Ativar ou desativar os métodos de pagamento: Yes para multi-pagamento ou No para a opção de pagamento único método.', 1, 'yes,no', 'webcustomerui');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(33, 'Inf. Pessoais', 'personalinfo', '1', 'Ativar ou desativar a página que permite o cliente modificar suas próprias informações pessoais.', 1, 'yes,no', 'webcustomerui');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(34, 'Inf. de Pagamento', 'customerinfo', '1', 'Ativar a exibição da interface de pagamento - Yes ou No.', 1, 'yes,no', 'webcustomerui');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(256, 'SMTP Secure', 'smtp_secure', '', 'Define o prefixo para o servidor SMTP: tls; ssl', 0, NULL, 'global');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(255, 'SMTP Port', 'smtp_port', '587', 'Porta para conectar no servidor SMTP', 0, NULL, 'global');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(254, 'Retornar URL de Esuqecimento de Senha', 'return_url_distant_forgetpassword', '', 'URL para o retorno específico se um erro ocorrer após a função Esqueci a Senha', 0, NULL, 'webcustomerui');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(47, 'WebPhone Server', 'webphoneserver', 'localhost', 'Endereço IP ou nome de domínio do servidor Asterisk que seria usado pelo web-phone.', 0, NULL, 'webcustomerui');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(49, 'Senha', 'password', '1', 'Deixar o usuário alterar a senha webui?', 1, 'yes,no', 'webcustomerui');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(50, 'Limite de CallerID', 'limit_callerid', '5', 'O número total de callerIDs para o reconhecimento de CLI que podem ser adicionar pelo cliente.', 0, NULL, 'webcustomerui');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(51, 'Nome do Tronco', 'sip_iax_info_trunkname', 'YourDomain', 'Nome do Tronco para mostrar em SIP/IAX info.', 0, NULL, 'sip-iax-info');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(52, 'Codecs Suportados', 'sip_iax_info_allowcodec', 'g729', 'Codecs Suportados: alaw, ulaw, gsm, g711, g729.', 0, NULL, 'sip-iax-info');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(53, 'Host', 'sip_iax_info_host', 'YourDomain.com', 'Informações de host.', 0, NULL, 'sip-iax-info');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(54, 'Parametros IAX', 'iax_additional_parameters', 'canreinvite = no', 'Parâmetros adicionais IAX.', 0, NULL, 'sip-iax-info');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(55, 'Parametros SIP', 'sip_additional_parameters', 'trustrpid = yes | sendrpid = yes | canreinvite = no', 'Parâmetros adicionais SIP.', 0, NULL, 'sip-iax-info');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(56, 'Abilitar', 'enable', '1', 'Ativar/Desativar.', 1, 'yes,no', 'epayment_method');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(57, 'Cliente de HTTP Server', 'http_server', 'http://www.YourDomain.com', 'Definir o endereço do servidor de Portal do Cliente, o campo deve estar vazio para servidores produtivos.', 0, NULL, 'epayment_method');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(58, 'Cliente de HTTPS Server', 'https_server', 'https://www.YourDomain.com', 'https://localhost - Digite aqui seu endereço de Servidor Seguro para clientes, não deve estar vazio para servidores produtivos.', 0, NULL, 'epayment_method');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(59, 'Servidor IP/Domain do Cliente', 'http_cookie_domain', '206.63.165.200', 'Digite o Nome de Domínio ou endereço IP para a aplicação dos clientes. Exemplo: 206.63.165.200.', 0, NULL, 'epayment_method');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(60, 'Servidor IP/Domain Seguro do Clientes ', 'https_cookie_domain', '206.63.165.200', 'Digite seu Nome de Domínio seguro do servidor ou endereço IP para a aplicação dos clientes, Exemplo: 206.63.165.200.', 0, NULL, 'epayment_method');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(61, 'Caminhoa dos Aplicativos de Clientes', 'http_cookie_path', '/customer/', 'Digite o caminho físico de seu Aplicativo de Clientes no servidor.', 0, NULL, 'epayment_method');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(62, 'Caminho Seguro dos Aplicativos de Clientes', 'https_cookie_path', '/customer/', 'Digite o caminho físico de seu Aplicativo de Clientes no servidor.', 0, NULL, 'epayment_method');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(63, 'Caminhoa Físico dos Aplicativos de Clientes', 'dir_ws_http_catalog', '/customer/', 'Digite o caminho físico dos Aplicativo de Clientes no servidor.', 0, NULL, 'epayment_method');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(64, 'Caminho Físico Seguro dos Aplicativos de Clientes', 'dir_ws_https_catalog', '/customer/', 'Digite o caminho físico de seu Aplicativo de Clientes no servidor.', 0, NULL, 'epayment_method');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(65, 'Abilitar SSL', 'enable_ssl', '1', 'Ativar servidor web seguro para procedimento de verificação geral?', 1, 'yes,no', 'epayment_method');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(66, 'Domínio HTTP', 'http_domain', '206.63.165.200', 'Endereço http.', 0, NULL, 'epayment_method');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(67, 'Caminho do Diretório', 'dir_ws_http', '/customer/', 'Caminho do Diretório.', 0, NULL, 'epayment_method');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(68, 'Tipos de Creditos', 'purchase_amount', '10:20:30:50:100', 'Distinguir a quantidade de compra de creditos que estarão disponíveis. No máximo 5 valores. Exemplo: 10:20:30:50:100', 0, NULL, 'epayment_method');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(69, 'Nome do Item', 'item_name', 'Comprar Créditos', 'Nome do item que seria exibido para o usuário quando ele vai comprar crédito.', 0, NULL, 'epayment_method');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(70, 'Codigo de Moeda', 'currency_code', 'BRL', 'Moeda para a compra de crédito. Apenas um moeda pode ser definida.', 0, NULL, 'epayment_method');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(71, 'URL de pagamento Paypal', 'paypal_payment_url', 'https://secure.paypal.com/cgi-bin/webscr', 'Defina aqui a URL do gateway paypal de pagamento (para testar com paypal sandbox).', 0, NULL, 'epayment_method');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(72, 'Verificar URL Paypal', 'paypal_verify_url', 'ssl://www.paypal.com', 'URL paypal de verificação de transação.', 0, NULL, 'epayment_method');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(73, 'URL dotNET autorizada ao pagamento', 'authorize_payment_url', 'https://secure.authorize.net/gateway/transact.dll', 'Defina a URL do Gateway autorizado a receber pagamentos.', 0, NULL, 'epayment_method');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(74, 'Nome da Loja no PayPal', 'store_name', 'Asterisk2Billing', 'Nome da loja no paypal para exibição no site paypal quando o cliente for pagar.', 0, NULL, 'epayment_method');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(75, 'Chave de transação', 'transaction_key', '9Wadfe893ajijkLl76FG75efdJghfhjhfFhj7FF7uffhY789HDGHhdkb2J', 'Chave de Transação para a segurança no pagamento eletronico. Máximo de 60 caracteres.', 0, NULL, 'epayment_method');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(76, 'Palavra Secreta', 'moneybookers_secretword', '', 'Palavra secreta para o Moneybookers.', 0, NULL, 'epayment_method');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(77, 'Ativar', 'enable_signup', '0', 'Ativar cadastro de modulos.', 1, 'yes,no', 'signup');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(78, 'Captcha Security', 'enable_captcha', '1', 'Ativar Captcha ao cadastrar modulos (valor: YES ou NO).', 1, 'yes,no', 'signup');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(79, 'Credito', 'credit', '0', 'Montante de crédito aplicado a um novo cliente.', 0, NULL, 'signup');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(80, 'Lista de ID do CallPlan', 'callplan_id_list', '1,2', 'A lista de ID de planos de chamadas que serão mostrados na inscrição.', 0, NULL, 'signup');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(81, 'Ativar Cartão', 'activated', '0', 'Especificar se o cartão é criado como ativo ou pendente.', 1, 'yes,no', 'signup');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(82, 'Tipo de Acesso', 'simultaccess', '0', 'Permitir ou não acessos simultaneos com o mesmo cartão. 0=Acesso Individual; 1=Acesso Simultaneo.', 0, NULL, 'signup');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(83, 'Tipo de Pagamento', 'typepaid', '0', '0=Cartão Pré-pago; 1=Cartão Pós-pago', 0, NULL, 'signup');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(84, 'Limite de Crédito', 'creditlimit', '0', 'Definir limite de crédito para um Cartão Pós-pago.', 0, NULL, 'signup');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(85, 'Executar Serviço', 'runservice', '0', 'Autorizar o serviço recorrente para aplicar sobre este cartão - 1=Yes - 0=No.', 0, NULL, 'signup');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(86, 'Abilitar Validade', 'enableexpire', '0', 'Ativar a validade do cartão  -  1=Yes - 0=No.', 0, NULL, 'signup');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(87, 'Formato da Data', 'expirationdate', '', 'Formato da data de validade DD-MM-AAAA HH:MM:SS. Por exemplo: 21/12/2012 00:00:00', 0, NULL, 'signup');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(88, 'Limite de validade', 'expiredays', '0', 'O número de dias limite, após esse prazo o cartão expira.', 0, NULL, 'signup');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(89, 'Gerar SIP', 'sip_account', '1', 'Criar uma conta SIP do cadastro ( default : yes ).', 1, 'yes,no', 'signup');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(90, 'Gerar IAX', 'iax_account', '1', 'Create an iax account from signup ( default : yes ).', 1, 'yes,no', 'signup');
